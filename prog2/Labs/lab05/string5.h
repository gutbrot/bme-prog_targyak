 ...
 *x  1  A paraméter nélkül hívható konstruktora üres sztringet hozzon létre! 
 *     Van olyan tagfüggvénye ( size() ), ami visszaadja a sztring hosszát.
 *x  2. Van olyan tagfüggvénye ( c_str() ), ami C-sztringgel, azaz nullával lezárt
 *     karaktersorozatra mutató pointerrel (const char *) tér vissza.
 *x  3. Van olyan konstruktora, ami karakterből hoz létre sztringet.
 *x  4. Van olyan konstruktora, ami C-sztringből (const char*) hoz létre sztringet.
