...
/// 1. feladat:
        ...
        int db = std::count_if(it1, it1 + 10, negativ<int>());
		cout << db << endl;
#endif // ELKESZULT >= 6

#if ELKESZULT >= 7
        cout << "darr-ban negativ: ";
        cout << std::count_if(darr.begin(), darr.end(), negativ<double>());		cout << endl;
#endif // ELKESZULT >= 7
        ...
        cout << std::count_if(darr.begin(), darr.end(), std::bind2nd(std::less<double>(), 100));		cout << endl;
#endif // ELKESZULT >= 8
